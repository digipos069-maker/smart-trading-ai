...
class BinanceMarketDataProvider:
    ...
    def status(self) -> ProviderStatus:
        try:
            ...
            return {"provider": self.name, "status": "not_connected", "message": str(exc)}
    ...
    def validate_symbol(self, symbol: str) -> str:
        ...
        if normalized not in BINANCE_SYMBOLS:
            ...
            raise ValueError(f"Unsupported Binance symbol '{symbol}'. Supported: {supported}")
    ...
    def validate_timeframe(self, timeframe: str) -> str:
        ...
        if normalized not in BINANCE_TIMEFRAMES:
            ...
            raise ValueError(f"Unsupported Binance timeframe '{timeframe}'. Supported: {supported}")
        return normalized
